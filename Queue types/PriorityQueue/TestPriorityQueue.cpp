...
#pragma region intkö
	PriorityQueue<int> T;
	PriorityQueue<int> T1;
	PriorityQueue<int> T2;
#pragma endregion
...
#pragma region Ladda kö	
	...
	//	som med hjälp av laddar kön med slumnpmässiga tal
	//
	/////////////////////////////////
	for (int i = 0; i < CAP; i++)
	{
...
#pragma region Dequeue
	...
	try
	{
		std::cout << "Dequeue T2: " << T2.front() << std::endl;
	}
	catch (const char* msg)
	{
		std::cerr << msg << std::endl;
...
#pragma region charkö
	PriorityQueue<char> ch1;
	PriorityQueue<char> ch2;
#pragma endregion
...
#pragma region Copy constructor
	...
	//	
	/////////////////////////////////
	PriorityQueue<char> ch3(ch1);
	try
	{
		std::cout << "ch2 efter copyconstrucktor ch1: " << ch3.front() << std::endl;
	}
	catch (const char* msg)
	{
		std::cerr << msg << std::endl;
